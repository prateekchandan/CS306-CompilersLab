...
int main() {
	CMachine M;
	M.execute();
	cout<<"Number of instructions executed: "<<instrs<<endl;
	cout<<"Number of load instructions executed: "<<loads<<endl;
	cout<<"Number of store instructions executed: "<<stores<<endl;
	cout<<"Number of push instructions executed: "<<pushs<<endl;
	cout<<"Number of pop instructions executed: "<<pops<<endl;
}
